...
#define isalnum(c)                                                             \
  ((_ctype + 1)[(unsigned char)(c)] & (CT_UP | CT_LOW | CT_DIG))
...
#define isgraph(c)                                                             \
  ((_ctype + 1)[(unsigned char)(c)] & (CT_PUN | CT_UP | CT_LOW | CT_DIG))
#define islower(c) ((_ctype + 1)[(unsigned char)(c)] & (CT_LOW))
#define isprint(c)                                                             \
  ((_ctype + 1)[(unsigned char)(c)] &                                          \
   (CT_PUN | CT_UP | CT_LOW | CT_DIG | CT_SP))
...
#define isblank(c)                                                             \
  ((_ctype + 1)[(unsigned char)(c)] & (CT_SP) || (c == '\t') || (c == ' '))
