...
uint8_t read_seconds_RTC() { return read_RTC_register(0x00); }

uint8_t read_minutes_RTC() { return read_RTC_register(0x02); }

uint8_t read_hours_RTC() { return read_RTC_register(0x04); }

uint8_t read_days_RTC() { return read_RTC_register(0x07); }

uint8_t read_months_RTC() { return read_RTC_register(0x08); }
